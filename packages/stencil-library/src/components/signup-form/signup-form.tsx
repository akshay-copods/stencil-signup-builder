              ...
              <div class="flex flex-col gap-20 ">
                ...
                <div class="max-w-[280px] gap-2 flex flex-col">
                  ...
                  >
                    ...
                    {/* <img onClick={() => (this.onEdit = !this.onEdit)} class="inline-block cursor-pointer w-4 h-4" src={editIcon} alt="" /> */}
                  </h1>
              ...
              <div class={`flex flex-col gap-7`}>
                ...
                <div class="flex flex-col gap-1">
                  {filterApprovelData.length > 0 && (
                    <span
                      style={{ fontSize: this.data.typography.normalText.fontSize, fontWeight: this.data.typography.normalText.bold ? 'bold' : null }}
                      class={` flex-wrap flex items-center gap-1 text-[#00000073] ${this.data.theme.color === 'dark' ? 'text-white' : 'text-black'}`}
                    >
                      <span>By continuing, you agree to the</span>
                      {filterApprovelData.includes('termsOfUse') && (
                        <a
                          class={this.data.typography.links.linkTypes}
                          href="/"
                          style={{ color: this.data.colors.primary, fontSize: this.data.typography.links.fontSize, fontWeight: this.data.typography.links.bold ? 'bold' : null }}
                        >
                          Terms of Service
                        </a>
                      )}
                      {filterApprovelData.length > 1 && (
                        <span
                          style={{ fontSize: this.data.typography.normalText.fontSize, fontWeight: this.data.typography.normalText.bold ? 'bold' : null }}
                  ...
                  {this.data.socialLoginButton.map((data: any) => {
                    return (
                      <div
                        ...
                        class={`border max-h-12 flex items-center shadow-md  ${
